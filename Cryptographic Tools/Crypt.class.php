...
abstract class Crypt {
	...
	/**
	 * Set the algorithm used for generate the final string - default is 'MCRYPT_3DES'
	 * @var string
	...
	/**
	 * Constructs the object to crypt strings, you may change the cipher and the mode, just pass the parameters to constructor.
	 * The default algorithm is MCRYPT_3DES and the default mode is ECB.
	 * If you don't know nothing about cryptographic methods, don't set any parameter
