...
class Conexao {
    ...
    private $credits;
    /**
     * Imprime um numero dentro da função.
     * @return number
     * @access public
     */
    public function ver() {
    ...
    /**
     * Funcao credits imprime texto seguido do funcao 'ver'.
     * @return string
     * @access public
     */
     ...
     * @param pede arquivo de conexão criptografado do banco de dados.
    ...
    public function connect() {
        try {
            $this -> conexao = new PDO(trim($this -> databaseData[0]), trim($this -> databaseData[1]), trim($this -> databaseData[2]), array(PDO::ATTR_PERSISTENT => true));
